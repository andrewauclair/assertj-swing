...
/**
 * Tests for {@link JTextComponentTextReader#supportedComponent()}.
 * 
 * @author Alex Ruiz
 */
class JTextComponentTextReader_supportedComponent_Test {
  @Test
  void should_Return_JTextComponent_Class() {
