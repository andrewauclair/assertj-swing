 ...
 * @author Alex Ruiz
 */
class AbstractComponentMatcher_requireShowingMatches_Test {
  ...
  @Test
  void should_Always_Match_If_RequireShowing_Is_False() {
  ...
  @Test
  void should_Match_If_RequireShowing_Is_True_And_Component_Is_Showing() {
  ...
  @Test
  void should_Not_Match_If_RequireShowing_Is_True_And_Component_Is_Not_Showing() {
    AbstractComponentMatcher matcher = new ConcreteComponentMatcher(true);
