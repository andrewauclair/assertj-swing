 ...
 * @author Yvonne Wang
 */
class WindowFinder_findDialog_withMatcher_withInvalidInput_Test {
  @Test
  ...
  void should_Throw_Error_If_Timeout_Is_Negative() {
    assertThrows(IllegalArgumentException.class, () -> WindowFinder.findDialog(neverMatches(JDialog.class)).withTimeout(-20));
  }
