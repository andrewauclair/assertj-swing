 ...
 * @author Alex Ruiz
 */
class WindowFinder_findDialog_byType_Test extends WindowFinder_TestCase {
  @Test
  ...
  void should_Fail_If_Dialog_Not_Found() {
    assertThrows(WaitTimedOutError.class, () -> WindowFinder.findDialog(DialogToLaunch.class).using(robot));
  }
}
