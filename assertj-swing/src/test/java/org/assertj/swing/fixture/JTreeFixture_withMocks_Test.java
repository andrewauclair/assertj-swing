 ...
 * @author Yvonne Wang
 */
class JTreeFixture_withMocks_Test {
  ...
  @Test
  void should_Call_ClickRow_In_Driver_And_Return_Self() {
    assertThat(fixture.clickRow(6)).isSameAs(fixture);
    verify(driver).clickRow(target, 6);
  }

  @Test
  void should_Call_ClickRow_With_MouseButton_In_Driver_And_Return_Self() {
    assertThat(fixture.clickRow(6, MIDDLE_BUTTON)).isSameAs(fixture);
    verify(driver).clickRow(target, 6, MIDDLE_BUTTON);
  }

  @Test
  void should_Call_ClickRow_With_MouseClickInfo_In_Driver_And_Return_Self() {
  ...
  @Test
  void should_Call_ClickPath_In_Driver_And_Return_Self() {
    assertThat(fixture.clickPath("root/child")).isSameAs(fixture);
    verify(driver).clickPath(target, "root/child");
  }

  @Test
  void should_Call_ClickPath_With_MouseButton_In_Driver_And_Return_Self() {
  ...
  @Test
  void should_Call_ClickPath_With_MouseClickInfo_In_Driver_And_Return_Self() {
    MouseClickInfo info = middleButton().times(3);
  ...
  @Test
  void should_Call_SelectPath_In_Driver_And_Return_Self() {
    assertThat(fixture.selectPath("root/child")).isSameAs(fixture);
    verify(driver).selectPath(target, "root/child");
  }

  @Test
  void should_Call_SelectPaths_In_Driver_And_Return_Self() {
  ...
  @Test
  void should_Call_UnselectRow_In_Driver_And_Return_Self() {
  ...
  @Test
  void should_Call_UnselectPath_In_Driver_And_Return_Self() {
    assertThat(fixture.unselectPath("root/child")).isSameAs(fixture);
    verify(driver).unselectPath(target, "root/child");
  }

  @Test
  void should_Call_UnselectPaths_In_Driver_And_Return_Self() {
    String[] paths = { "root", "root/child" };
  ...
  @Test
  void should_Return_JPopupMenu_At_Path_Using_Driver() {
    JPopupMenu popupMenu = mock(JPopupMenu.class);
  ...
  @Test
  void should_Call_RequireSelection_With_Rows_In_Driver_And_Return_Self() {
    int[] rows = { 6, 8 };
  ...
  @Test
  void should_Call_RequireSelection_With_Paths_In_Driver_And_Return_Self() {
    String[] paths = { "root", "root/child" };
  ...
  @Test
  void should_Return_Path_Separator_Using_Driver() {
  ...
  @Test
  void should_Call_ReplaceSeparator_In_Driver_And_Return_Self() {
    assertThat(fixture.replaceSeparator(":")).isSameAs(fixture);
    verify(driver).replaceSeparator(":");
  }

  @Test
  void should_Call_ReplaceCellReader_In_Driver_And_Return_Self() {
  ...
  @Test
  void should_Return_JTreeRowFixture() {
  ...
  @Test
  void should_Return_JTreePathFixture() {
  ...
  @Test
  void should_Return_Value_At_Row_Using_Driver() {
  ...
  @Test
  void should_Return_Value_At_Path_Using_Driver() {
