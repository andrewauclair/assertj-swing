...
public class JTableDriver_unselectRows_withInvalidInput_Test extends RobotBasedTestCase {
  ...
  void should_Throw_Error_If_Array_Of_Indices_Is_Null() {
    assertThrows(IllegalArgumentException.class, () -> driver.unselectRows(table, null));
  }

  @Test
  void should_Throw_Error_If_Array_Of_Indices_Is_Empty() {
    assertThrows(IllegalArgumentException.class, () -> driver.unselectRows(table, new int[0]));
  }
}
