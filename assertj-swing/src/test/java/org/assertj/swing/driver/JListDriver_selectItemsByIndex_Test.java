 ...
 * @author Yvonne Wang
 */
class JListDriver_selectItemsByIndex_Test extends JListDriver_TestCase {
  @Test
  ...
  void should_Throw_Error_If_JList_Is_Disabled() {
    disableList();
    ExpectedException.assertIllegalStateIsDisabledComponent(() -> driver.selectItems(list, new int[] { 1, 2 }));
  }

  @Test
  void should_Throw_Error_If_JList_Is_Not_Showing_On_The_Screen() {
    ExpectedException.assertIllegalStateIsNotShowingComponent(() -> driver.selectItems(list, new int[] { 1, 2 }));
  }
}
