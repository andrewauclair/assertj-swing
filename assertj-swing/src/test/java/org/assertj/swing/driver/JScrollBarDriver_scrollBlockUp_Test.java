 ...
 * @author Alex Ruiz
 */
class JScrollBarDriver_scrollBlockUp_Test extends JScrollBarDriver_TestCase {
  @Test
  ...
  void should_Throw_Error_If_JScrollBar_Is_Disabled() {
    disableScrollBar();
    ExpectedException.assertIllegalStateIsDisabledComponent(() -> driver.scrollBlockUp(scrollBar));
  }

  @Test
  void should_Throw_Error_If_JScrollBar_Is_Not_Showing_On_The_Screen() {
    ExpectedException.assertIllegalStateIsNotShowingComponent(() -> driver.scrollBlockUp(scrollBar));
  }
}
