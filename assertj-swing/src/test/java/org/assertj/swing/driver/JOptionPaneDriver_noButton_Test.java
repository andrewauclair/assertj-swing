...
/**
 * Tests for {@link JOptionPaneDriver#noButton(JOptionPane)}.
 * 
 * @author Alex Ruiz
 */
class JOptionPaneDriver_noButton_Test extends JOptionPaneDriver_TestCase {
  @Test
  void should_Find_No_Button() {
