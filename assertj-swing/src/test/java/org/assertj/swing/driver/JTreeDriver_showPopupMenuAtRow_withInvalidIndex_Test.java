 ...
 * @author Alex Ruiz
 */
class JTreeDriver_showPopupMenuAtRow_withInvalidIndex_Test extends JTreeDriver_TestCase {
  ...
  void should_Throw_Error_If_Given_Row_Index_Is_Out_Of_Bounds(int invalidRow) {
    showWindow();
    assertThrows(IndexOutOfBoundsException.class, () -> driver.showPopupMenu(tree, invalidRow));
  }
}
