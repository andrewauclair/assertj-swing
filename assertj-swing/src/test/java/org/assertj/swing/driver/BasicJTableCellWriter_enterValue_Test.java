 ...
 * @author Alex Ruiz
 */
class BasicJTableCellWriter_enterValue_Test extends JTableCellWriter_enterValue_TestCase {
  @Override
  ...
  @Test
  void should_Select_Item_In_JComboBox_Editor() {
    writer.enterValue(table, 0, 2, "Pool");
    assertThat(valueAt(0, 2)).isEqualTo("Pool");
  }

  @Test
  void should_Check_In_JCheckBox_Editor() {
    int row = 0;
    int col = 4;
  ...
  @Test
  void should_Enter_Text_In_JTextComponent_Editor() {
